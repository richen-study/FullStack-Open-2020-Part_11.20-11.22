...
describe("total likes", () => {
  ...
  test("when given a bigger list, returns total likes", () => {
...
describe("Most Blogs by Author", () => {
  ...
  test("return which author has the most blogs", () => {
...
describe("Most Likes by Author", () => {
  ...
  test("return which author has the most likes, with total likes of author", () => {
